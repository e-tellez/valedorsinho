...
export default function AuthCaptPage() {
  ...
  return (
    <div className="w-full max-w-[700px]">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mt-3 mb-2">Auth + Capture</h1>
      <p className="text-sm text-gray-500 mb-5">Pre-authorize then capture in separate steps.</p>
