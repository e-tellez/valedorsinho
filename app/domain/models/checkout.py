"""Checkout domain models — pure value objects with no framework dependencies.

These map Python-style attributes to the camelCase keys expected by the
Adyen Checkout API.  Using Pydantic gives automatic validation, camelCase
serialisation via aliases, and a single place to see every field a request
can carry.
"""
